...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        id="ms-side-nav"
        className="side-nav fixed ms-aside-scrollable ms-aside-left ps--active-y"
      >
        ...
        <ul className="accordion ms-main-aside fs-14" id="side-nav-accordion">
          ...
          <li className="menu-item">
            ...
            >
              <span>
                <i className="fa fa-user"></i>manage Service Users
              </span>
            </Link>
            <ul
              id="patient"
            ...
            >
              <li>
                <Link to="/add-service-user">Add Service Users</Link>
              </li>
              <li>
                <Link to="/serviceuser-list">Service Users</Link>
              </li>
              {/* <li><Link to="/adddocument">Add Document</Link> </li>
          <li> <Link to="/documentlist">Document List</Link> </li> */}
              <li>
                <Link to="/service-user-status">Servic User Status</Link>
              </li>
              <li>
                <Link to="/service-user-enquiry">Service User Enquiry</Link>
              </li>
              <li>
                <Link to="/grouping">Grouping</Link>
              </li>
            </ul>
          </li>
          ...
          <li class="menu-item">
            <a
              ...
              class="has-chevron"
              data-toggle="collapse"
              data-target="#patient1"
              aria-expanded="false"
              aria-controls="patient1"
            >
              <span>
            ...
            <ul
              id="patient1"
              class="collapse"
              aria-labelledby="patient1"
              data-parent="#side-nav-accordion"
            >
              <li>
                <a href="#">Scored assessment</a>
              </li>
              <li>
                <a href="#">General risk assessments</a>
              </li>
              <li>
                <a href="#">Risk assessments </a>
              </li>
              <li>
                <a href="#">Person centred care plan </a>
              </li>
              <li>
                <a href="#">MCA</a>
              </li>
          ...
          <li className="menu-item">
            <Link to="#">
              <span>
                <i className="fa fa-list"></i>Policies and Procedures
              </span>
            </Link>
          </li>
          ...
          <li className="menu-item">
            <a href="#">
              <span>
                <i className="fa fa-list"></i>Admin and General
              </span>
            </a>
          </li>
          ...
          <li className="menu-item">
            <Link to="/calendar">
              <span>
                <i className="fa fa-calendar-days"></i>Calendar
              </span>
            </Link>
          </li>
          ...
          <li className="menu-item">
            <a href="#">
              <span>
                <i className="fa fa-arrow-up"></i>Follow Up
              </span>
            </a>
          </li>
          ...
          <li className="menu-item">
            <a href="#">
              <span>
                <i className="fa fa-list"></i>Handover
              </span>
            </a>
          </li>
          ...
          <li className="menu-item">
            <Link to="/monthlyreview">
              <span>
                <i className="fa fa-star"></i>Monthly Review
              </span>
            </Link>
          </li>
          ...
          <li className="menu-item">
            <Link to="/reception">
              <span>
                <i className="fa fa-tasks"></i> Reception Management
              </span>
            </Link>
          </li>
          ...
          <li className="menu-item">
            <Link to="/messages">
              <span>
                <i className="fa fa-list"></i>Messages
              </span>
            </Link>
          </li>
          ...
          <li class="menu-item">
            ...
            >
              <span>
                <i class="fas fa-list-alt"></i>Staff Management
              </span>
            </a>
            <ul
              id="schedule"
            ...
            >
              <li>
                <Link to="/employee">Staff Management</Link>
              </li>
              <li>
                <a href="#">Holiday & Absense</a>
              </li>
              <li>
                <Link to="/add-staff">Add Staff</Link>
              </li>
              <li>
                <Link to="/empcompliance">Employment Compliance Checklist</Link>
              </li>
            </ul>
          </li>
          ...
          <li className="menu-item">
            <Link to="#">
              <span>
                <i className="fa fa-list"></i>Staff roaster
              </span>
            </Link>
          </li>
          ...
          <li className="menu-item">
            <Link to="/logs">
              <span>
                <i className="fa fa-list"></i>Daily Notes
              </span>
            </Link>
          </li>
          ...
          <li className="menu-item">
            <Link to="/todolist">
              <span>
                <i className="fa fa-list"></i>Add To Do's
              </span>
            </Link>
          </li>
          ...
          <li className="menu-item">
            <Link to="/keycontacts">
              <span>
                <i className="fa fa-list"></i>Key Contacts
              </span>
            </Link>
          </li>
          ...
          <li className="menu-item">
            <Link to="/support">
              <span>
                <i className="fa fa-list"></i>Support
              </span>
            </Link>
          </li>
          ...
          <li class="menu-item">
            <Link to="/billings">
              <span>
                <i class="fas fa-cog"></i>Billing &amp; Subscriptions
              </span>
            </Link>
          </li>
          ...
          <li class="menu-item">
            <a
              ...
              class="has-chevron"
              data-toggle="collapse"
              data-target="#patientset"
              aria-expanded="false"
              aria-controls="patientset"
            >
              <span>
            ...
            <ul
              id="patientset"
              class="collapse show"
              aria-labelledby="patientset"
              data-parent="#side-nav-accordion"
            >
              {/* <!--<li> <a href="https://lamavietech.ml/wisterias/pages/all/zones.html">Zones</a> </li>--> */}

              <li>
                <Link to="/billings">Billing &amp; Subscriptions</Link>
              </li>
              <li>
                <Link to="#">Shift password</Link>
              </li>
              <li>
                <Link to="#">Staff access request</Link>
              </li>
            </ul>
          </li>
