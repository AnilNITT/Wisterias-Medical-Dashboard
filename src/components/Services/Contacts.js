    ...
    <div className="ms-content-wrapper">
        <div className="row">
            ...
            <div class="new_modals">
                <div class="modal fade none-border" id="createcontact" Style="display: none;" aria-hidden="true">
                                        ...
                                        <div class="row">
                                               ...
                                               <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input Style="color: #2196f3;" type="text" class="form-control" placeholder="Title"/>
                                                </div>
                                            </div>
                                            
                                            <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Name<span class="man_fields1">*</span></label>
                                               ...
                                               <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Address 1<span class="man_fields1">*</span></label>
                                                    <input type="text" id="pac-input" class="form-control pac-target-input" placeholder="Enter Address" autocomplete="off"/>
                                                </div>
                                            </div>
                                            
                                               <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Address 2<span class="man_fields1">*</span></label>
                                                    <input type="text" id="pac-input" class="form-control" placeholder="Enter Address"/>
                                                </div>
                                            </div>
                                            
                                               <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Address 3<span class="man_fields1">*</span></label>
                                                    <input type="text" id="pac-input" class="form-control" placeholder="Enter Address"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Contact number<span class="man_fields1">*</span></label>
                                            ...
                                            <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
                                                      <label for="exampleInputEmail1">Relationship<span class="man_fields1">*</span></label>
