          ...
          <div class="col-md-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb pl-0">
                ...
                <li class="breadcrumb-item creta_buot">
                  <a
                    class="btn btn-primary"
                    href="#"
                    data-toggle="modal"
                    data-target="#createdoc"
                  >
                    Create New
                  </a>
                </li>
                      ...
                      <div class="row">
                        <div class="col-sm-4">
                          ...
                          <div>
                            <button
                              type="button"
                              class="btn btn-success search_btn"
                            ...
                            <button
                              type="button"
                              class="btn view btn-success search_btn"
                              onclick="SearchPatients()"
                              id="sbtn1"
                              Style="margin-top:1rem; background: rgb(221, 221, 221); border-color: rgb(221, 221, 221);"
                            >
              ...
              <div class="ms-panel-body">
                <div class="table-responsive">
                  ...
                  <table
                    ...
                    Style="border-top: 2px solid #651f70;"
                  >
                    <tbody>
                  ...
                  <div role="form">
                    <div class="row">
                      <div class="col-sm-12 col-lg-12">
                        <div class="form-group">
                          <label for="exampleInputEmail1">
                            Document Title<span class="man_fields1">*</span>
                          </label>
                          <input
                            class="form-control"
                            name="documenttitle"
                      ...
                      <div class="col-sm-12 col-lg-12">
                        <div class="form-group">
                          <label for="exampleInputEmail1">
                            Folder<span class="man_fields1">*</span>
                          </label>
                          <select class="form-control">
                      ...
                      <div class="col-sm-12 col-lg-12">
                        <div class="form-group">
                          <label for="exampleInputEmail1">
                            Upload document<span class="man_fields1">*</span>
                          </label>
                          <input
                            type="file"
                            class="form-control"
                  ...
                  <div role="form">
                    <div class="row">
                      ...
                      >
                        <div class="form-group">
                          <label for="exampleInputEmail1">
                            Category name<span class="man_fields1">*</span>
                          </label>
                          <input
                            class="form-control"
                            name="category"
