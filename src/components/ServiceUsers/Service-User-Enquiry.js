      ...
      <div class="row">
          ...
          <div class="col-md-12">
            ...
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active">Service User Enquiry <Link class="btn btn-primary" to="/add-service-user-enquiry" Style="float:right; margin-top:0px;" data-toggle="modal" data-target="#create">Create New</Link></li>
            </ol>
          </nav>
          <div class="ms-panel">
          <div>
                        <div class="section_box1_content2">
                            <div class="row">
                                <div class="col-sm-12">
                                  ...
                                  <div class="col-sm-3">
                                        <input type="text" class="form-control" id="txtsrch" placeholder="created by search "/>
                                  </div>
                                   
                                   <div class="col-sm-3">
                                    <input type="date" class="form-control" id="txtsrch" placeholder="created by dates "/>
                                   </div>
                                   ...
                                   <div class="col-sm-12">
                                       ...
                                       <button type="button" class="btn view btn-success search_btn" onclick="SearchPatients()" id="sbtn1" Style=" margin-top:1rem; border-color: rgb(221, 221, 221);">Show close Cases </button>
