    ...
    <main className="body-content">
               ...
               <div class="col-xl-12 col-md-12">
                  <div class="ms-panel">
                     ...
                     <div class="ms-panel-body">
                        ...
                        <div id="seconddivitems" Style="display:block;">
		...
		<img src="../../assets/img/cat-icon/Pudding.png" alt="people" Style="background:#136D97"/>
			...
			<div class="col-xl-12 col-md-12" Style="text-align: center;">
                    <button class="btn btn-primary mt-4 d-inline w-20" type="submit"><Link to="/addlogsstep3">Next</Link></button>
            </div>
         </div>
      </div>
    </main>
