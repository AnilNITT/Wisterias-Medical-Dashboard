  ...
  return (
    <main className="body-content">
           ...
           <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb pl-0">
                            ...
                            <li class="breadcrumb-item active">Continuous Professional Development - John Doe <a class="btn btn-primary" href="#" Style="float:right; margin-top:0px;" data-toggle="modal" data-target="#createcpd">Create New</a></li>
                        </ol>
                    </nav>
                    <div class="ms-panel">
                        ...
                        <div class="ms-panel-body">
                            <div class="table-responsive">
                                <div id="data-table-2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="data-table-2_length"><label>Show <select name="data-table-2_length" aria-controls="data-table-2" class="custom-select custom-select-sm form-control form-control-sm"><option value="12">12</option><option value="25">25</option><option value="30">30</option><option value="-1">Todos</option></select> </label></div></div><div class="col-sm-12 col-md-6"><div id="data-table-2_filter" class="dataTables_filter"><label><input type="search" class="form-control form-control-sm" placeholder="Search Data..." aria-controls="data-table-2"/></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-striped thead-primary w-100 dataTable no-footer" id="data-table-2" role="grid" aria-describedby="data-table-2_info">
                                 <thead>
                                 <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Course Name: activate to sort column descending" Style="width: 191.984px;">Course Name</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Start Date: activate to sort column ascending" Style="width: 72.1562px;">Start Date</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Completed Date: activate to sort column ascending" Style="width: 114.844px;">Completed Date</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Valid Until: activate to sort column ascending" Style="width: 118.016px;">Valid Until</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Edit: activate to sort column ascending" Style="width: 62px;">Edit</th></tr>
                                </thead>
                                   <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td class="sorting_1">Master of Science in Cardiology</td>
                                    <td>10/05/2021</td>
                                    <td>07/03/2022</td>
                                    <td>08/04/2022 <span class="badge badge-danger">Expired</span></td>
                                    ...
                                    <td class="sorting_1">Master of Science in Neurology</td>
                                    <td>09/06/2021</td>
                                    <td>12/04/2022</td>
                                    <td>08/05/2022 <span class="badge badge-danger">Expired</span></td>
       ...
       <div class="new_modals">
                <div class="modal fade none-border" id="createcpd" Style="display: none;" aria-hidden="true">

                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                               <h4 class="modal-title"><strong>Continuous Professional Development</strong></h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Course Name<span class="man_fields1">*</span></label>
                                                    <input type="text" class="form-control" placeholder="Course Name"/>
                                                </div>
                                            </div>
                                             <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Awarded By<span class="man_fields1">*</span></label>
                                                    <input type="text" class="form-control" placeholder="Awarded By"/>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-lg-12">
                                                <div class="form-group">
