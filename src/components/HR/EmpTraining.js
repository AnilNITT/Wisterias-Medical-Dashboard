  ...
  return (
    <main className="body-content">
           ...
           <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb pl-0">
                            ...
                            <li class="breadcrumb-item active">Training - John Doe <a class="btn btn-primary" href="#" Style="float:right; margin-top:0px;" data-toggle="modal" data-target="#createtraining">Create New</a></li>
                        </ol>
                    </nav>
                    <div class="ms-panel">
                        ...
                        <div class="ms-panel-body">
                            <div class="table-responsive">
                                <div id="data-table-2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="data-table-2_length"><label>Show <select name="data-table-2_length" aria-controls="data-table-2" class="custom-select custom-select-sm form-control form-control-sm"><option value="12">12</option><option value="25">25</option><option value="30">30</option><option value="-1">Todos</option></select> </label></div></div><div class="col-sm-12 col-md-6"><div id="data-table-2_filter" class="dataTables_filter"><label><input type="search" class="form-control form-control-sm" placeholder="Search Data..." aria-controls="data-table-2"/></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-striped thead-primary w-100 dataTable no-footer" id="data-table-2" role="grid" aria-describedby="data-table-2_info">
                                 <thead>
                 <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Start Date: activate to sort column descending" Style="width: 66.1406px;">Start Date</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Course Name: activate to sort column ascending" Style="width: 90.2656px;">Course Name</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Area: activate to sort column ascending" Style="width: 50.4844px;">Area</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Completed Date: activate to sort column ascending" Style="width: 106.578px;">Completed Date</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Valid Until: activate to sort column ascending" Style="width: 67.6875px;">Valid Until</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" Style="width: 53.5938px;">Status</th><th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" Style="width: 47.1875px;">Action</th></tr>
        </thead>
                                   <tbody>
                                ...
                                <tr role="row" class="odd">
                                    <td class="sorting_1">10/05/2019</td>
                                    <td>MSc</td>
                                    <td>lorenipsum</td>
                                    <td>12/12/2020</td>
                                    <td>12/12/2021</td>
                                    ...
                                    <td class="sorting_1">10/05/2020</td>
                                    <td>BSc</td>
                                    <td>lorenipsum</td>
                                    <td>12/12/2021</td>
                                    <td>01/01/2022</td>
                                    ...
                                    <td class="sorting_1">10/05/2021</td>
                                    <td>MSc</td>
                                    <td>lorenipsum</td>
                                    <td>12/12/2022</td>
                                    <td>01/01/2023</td>
       ...
       <div class="new_modals">
                <div class="modal fade none-border" id="createtraining" Style="display: none;" aria-hidden="true">

                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                               <h4 class="modal-title"><strong>Training</strong></h4>
                                    ...
                                    <div role="form">
                                        <div class="row">
                                               ...
                                               <div class="form-group col-md-12">
                                                    ...
                                                    <label for="exampleInputEmail1">Course<span class="man_fields1">*</span></label>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <label for="exampleInputEmail1">Area<span class="man_fields1">*</span></label>
                                                    <select class="form-control">
                                                        <option>Select Area</option>
                                                        <option>saada</option>
                                                        <option>daddada</option>
                                                    </select>
                                                
                                               </div>
                                               <div class="form-group col-md-12">
                                                 
                                                    <label for="exampleInputEmail1">Start Date<span class="man_fields1">*</span></label>
                                                    <input type="date" class="form-control"/>
                                                
                                               </div>
                                             <div class="form-group col-md-12">
                                                 
                                                    <label for="exampleInputEmail1">End Date<span class="man_fields1">*</span></label>
                                                    <input type="date" class="form-control"/>
