...
const Messages = () => {
  return(
    ...
    <div class="sub_section" Style="width: 100%;">
                                ...
                                <div class="col-sm-12" Style="padding: 0px 0px 0px 15px;">
                                    <div class="tab_menus" Style="float:left;">
                                        <ul>
                                            ...
                                            <li class="active"><Link to="/messages" class="active">Inbox</Link></li>
                                            <li><Link to="/message-outbox">Outbox</Link></li>
        ...
        <input type="radio" name="radio" value="" onclick="show1();"/> User
        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="checkbox-inline">
      <input type="radio" name="radio" value="" onclick="show2();"/> Role
    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="checkbox-inline">
      <input type="radio" name="radio" value="" onclick="show3();"/> Department
    </label><br/>
    ...
    <div id="dd1" Style="display:none;">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="checkbox-inline">
      <input type="checkbox" value=""/> Filip Brion
    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="checkbox-inline">
      <input type="checkbox" value=""/> Jenifer
    </label>
    </div>
    <div id="dd2" Style="display:none;">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="checkbox-inline">
      <input type="checkbox" value=""/> Carer
    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="checkbox-inline">
